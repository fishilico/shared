...
#define R_RAX(ctx) asm_instr_ctx_reg_with_gregs((ctx), RAX, Rax)
#define R_RBX(ctx) asm_instr_ctx_reg_with_gregs((ctx), RBX, Rbx)
#define R_RCX(ctx) asm_instr_ctx_reg_with_gregs((ctx), RCX, Rcx)
#define R_RDX(ctx) asm_instr_ctx_reg_with_gregs((ctx), RDX, Rdx)
#define R_RSP(ctx) asm_instr_ctx_reg_with_gregs((ctx), RSP, Rsp)
#define R_RBP(ctx) asm_instr_ctx_reg_with_gregs((ctx), RBP, Rbp)
#define R_RSI(ctx) asm_instr_ctx_reg_with_gregs((ctx), RSI, Rsi)
#define R_RDI(ctx) asm_instr_ctx_reg_with_gregs((ctx), RDI, Rdi)
#define R_R8(ctx) asm_instr_ctx_reg_with_gregs((ctx), R8, R8)
#define R_R9(ctx) asm_instr_ctx_reg_with_gregs((ctx), R9, R9)
#define R_R10(ctx) asm_instr_ctx_reg_with_gregs((ctx), R10, R10)
#define R_R11(ctx) asm_instr_ctx_reg_with_gregs((ctx), R11, R11)
#define R_R12(ctx) asm_instr_ctx_reg_with_gregs((ctx), R12, R12)
#define R_R13(ctx) asm_instr_ctx_reg_with_gregs((ctx), R13, R13)
#define R_R14(ctx) asm_instr_ctx_reg_with_gregs((ctx), R14, R14)
#define R_R15(ctx) asm_instr_ctx_reg_with_gregs((ctx), R15, R15)
#define R_RIP(ctx) asm_instr_ctx_reg_with_gregs((ctx), RIP, Rip)
